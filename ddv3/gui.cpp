...
long __stdcall WindowProcess(HWND window, UINT message, WPARAM wideParameter, LPARAM longParameter) {
	...
	case WM_MOUSEMOVE: {
		if (wideParameter == MK_LBUTTON) {
			...
			rect.top += points.y - gui::position.x;
...
void gui::Render() noexcept {
	...
	ImGui::Begin("subscribe to cazzy", &exit, ImGuiWindowFlags_NoResize | ImGuiTableFlags_NoSavedSettings || ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoMove);
